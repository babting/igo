...
public class UrlUtilities {
 ...
 /*        RequestContext requestContext = RequestContext.getRequestContext();
    ...
    public static URL buildUrl(
    	...
    	return UrlUtilities.buildUrl("http://", host, port, path, parameters);
    }
    ...
    public static URL buildPostUrl(String protocol, String host, int port, String path) throws MalformedURLException {
        StringBuffer buffer = new StringBuffer();
        buffer.append(protocol);
        buffer.append(host);
        if (port > 0) {
